...
libraryDependencies += "gg.sina" %% "monadic-simplifier" % "0.1.0-SNAPSHOT"
libraryDependencies += "gg.sina" %% "monadic-simplifier-play-json" % "0.1.0-SNAPSHOT"
libraryDependencies += "gg.sina" %% "agent" % "0.1.0-SNAPSHOT"
